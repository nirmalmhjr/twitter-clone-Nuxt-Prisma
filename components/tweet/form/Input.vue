    ...
    <div>
        <div class="flex items-center flex-shrink-0 p-4 pb-0">
            ...
            <div class="flex w-12 items-top">
                <img :src="props.user?.profileImage" alt="" class="inline-block w-10 rounded-full">
            </div>
            <div class="w-full p-2">
                <textarea
                    v-model="text"
                    class="w-full h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0 dark:text-white focus:ring-0" :placeholder="props.placeholder"></textarea>
            </div>
        </div>
        <!-- File Selector -->
        <div class="p-4 pl-16">
      ...
      <g>
          ...
          <circle cx="8.868" cy="8.309" r="1.542"></circle>
            ...
            <div class="p-2 text-blue-400 rounded-full hover:bg-blue-50 cursor-pointer dark:hover:bg-dim-800">
                <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
    <g>
        <path
        ...
        <path
            ...
            <div class="p-2 text-blue-400 hover:bg-blue-50 rounded-full cursor-pointer dark:hover:bg-dim-800">
                <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
      <g>
          <path
      ...
      <g>
        ...
        <!-- Button -->
        <div class="ml-auto" >
            <UI-Button size="sm" :disabled="isDisabled" @onClick="handleFormSubmit">
...
<script setup>
    ...
    function handleImageChange(event){
        ...
        const reader = new FileReader() //1st ma object banayau
